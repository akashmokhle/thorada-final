        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="deal" style="background-image: url('')">
                        <div class="deal-top">
            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="logo logo-width-1">
                        <a href="/"><img src="/assets/imgs/logo/thorada-logo-black.png" class="shadow rounded" alt="logo" /></a>
                    </div>
                        ...
                        <div class="header-action-right">
                            <div class="header-action-2">
                                ...
                                <div class="header-action-icon-2 ">
                                    ...
                                    <div class=" cart-dropdown-wrap cart-dropdown-hm2 " style="min-width:450px;" >
                                                    ...
                                                    <table>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td><h4><i class="fa-solid fa-indian-rupee-sign"></i> {{ item.price }}/-</h4></td>
                                                                <td><h4><span></span><i class="fa-solid fa-indian-rupee-sign"></i> {{ (item.qty * item.price) }} /-</h4></td>
                                                                <td>
                                                                    <div class="shopping-cart-delete">
                                                                        <a @click="removeItemFromCart(index)" href="javascript:void(0)"><i class="fi-rs-cross-small"></i></a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                        ...
                                        <div class="shopping-cart-footer">
                                            <div class="shopping-cart-total">
                                                <h4>Total <span><i class="fa-solid fa-indian-rupee-sign"></i> {{ totalCartAmount }}/-</span></h4>
                                            </div>
                                            <div class="shopping-cart-button">
                                                <nuxt-link to="/shopping-cart" class="outline">View cart</nuxt-link>
        ...
        <div class="mobile-header-wrapper-inner">
            ...
            <div class="mobile-header-content-area">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <p class="font-sm mb-0">&copy; {{ currentYear }} <strong class="text-brand">Thorada Services</strong> Developed with<br />by <a href="https://sitentweb.com/" class="text-amber-500" target="_blank">Sitent Web & Graphics Design</a></p>
                </div>            
            </div>
        </div>
    </div>
	...
	export default {
		...
		methods: {
            ...
            computed: {
				...
				cartItems() {
					const cartStore = useCartStore(apiBaseUrl.addProductToCart);
