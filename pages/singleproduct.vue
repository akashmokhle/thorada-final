        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb" >
                    ...
                    <span></span> <a href="#">{{product.p_name}}</a> <span></span>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-xl-9">
                            <div class="product-detail accordion-detail">
                                <div class="row mb-50 mt-30">
									...
									<li class="owl2-item" v-for="(image, index) in product.product_medias">
										<a :data-index="index"  class="img thumbnail" :data-image="baseUrl +image.pm_image" :title="product.p_name">
											<img :src="baseUrl + image.pm_image" @click="viewProductImage = image.pm_image" :title="product.p_name" :alt="product.p_name">
										</a>
									</li>
								</ul>
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xs-12">
                                        <div class="detail-info pr-30 pl-30">
                                            ...
                                            <h2 class="title-detail">{{product.p_name}}</h2>
...
// import { sliderUpdate } from '~~/config/sliderUpdate';
...
data() {
	...
	methods: {
		async init() {
			...
			const response = await axios.get('https://thoradaadmin.sitentweb.com/api/product-details?slug='+this.productSlug);

			if(response.status == 200) {

				if(response.data.status) {
					var images = []
					response.data.data.product_medias.forEach((image) => {
						images.push({
							src: this.baseUrl + image.pm_image
						});
					});
					...
					this.viewProductImage = this.product.product_medias[0].pm_image;
					
					await  $('.large-image').magnificPopup({
						items: images,
	...
	// 		await sliderUpdate.updateSingleProductSlider();
	// 		await sliderUpdate.updateSlider();
	// 	});
 
	// 	await sliderUpdate.zoomImage();

	// },
	changeViewProductImage() {
