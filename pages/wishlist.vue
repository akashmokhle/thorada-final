                ...
                <div class="col-xl-10 col-lg-12 m-auto">
                    ...
                    <div class="table-responsive shopping-summery">
                        <table class="table table-wishlist">
                            ...
                            <tbody>
                                <tr v-for="(item, index) in wishItems" class="pt-30">
                                    ...
                                    <td class="product-des product-name">
                                        <h6><a class="product-name mb-10" href="/singleproduct">{{item.title}}</a></h6>
                                    ...
                                    <td class="text-right" data-title="Cart">
                                        <button @click="addToCart()" class="btn btn-sm">Add to cart</button>
                                    </td>
                                    <td class="action text-center" data-title="Remove">
                                        <a href="javascript:void(0)" @click="removeProductFromWishList(index)" class="text-body"><i class="fi-rs-trash"></i></a>
                                    </td>
                                </tr>
                                <!-- <tr>
                                    <td class="custome-checkbox pl-30">
	...
	export default {
		...
		methods: {
			removeProductFromWishList(index) {
				...
				wishlistStore.removeProductFromWishList(index);	
			},
			async addToCart() {
		...
		computed: 	{
				...
				wishItems(){
					const wishlistStore = useWishlistStore();
					return wishlistStore.CartwishList.reverse();
				},
				...
				totalCartAmount() {
					...
					var amount = 0;
					wishlistStore.CartwishList.forEach((product) => {
				...
				totalCartAmountGst() {
					...
					return (this.totleCartAmount *18) / 100;
