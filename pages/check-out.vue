                    ...
                    <div class="border p-20 cart-totals ml-30 mb-50">
                        ...
                        <div class="table-responsive order_table checkout">
                            <table class="table no-border">
                                <tbody v-for="(item, index) in cartItems">
                                    <tr >
                                        <td class="image product-thumbnail"><img :src="item.image" alt="#"></td>
                                        <td>
                                            <h6 class="w-160 mb-5"><a href="" class="text-heading"> {{ item.title }}</a></h6>
                                        ...
                                        <td>
                                            <h6 class="text-brand"><i class="fa-solid fa-indian-rupee-sign"></i> {{ (item.qty * item.price) }}/-</h6>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
